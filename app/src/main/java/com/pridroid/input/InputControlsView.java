...
public class InputControlsView extends View {
    ...
    private static final String TAG = "PriDroid/Controls";
    ...
    public InputControlsView(Context c, float renderScale, String instanceName) {
        ...
        if (instanceName != null) {
            hapticEnabled = new com.pridroid.InstanceSettings(instanceName).isHapticFeedback();
        } else {
    ...
    public void loadFromPrefsOrDefault() {
        String json = null;
        if (instanceName != null) {
            json = new com.pridroid.InstanceSettings(instanceName).getControlsJson();
        } else {
            LauncherPreferences lp = LauncherPreferences.getSingleton();
    ...
    public void saveToPrefs() {
        if (instanceName != null) {
            new com.pridroid.InstanceSettings(instanceName).setControlsJson(toJson());
        } else {
            LauncherPreferences lp = LauncherPreferences.getSingleton();
