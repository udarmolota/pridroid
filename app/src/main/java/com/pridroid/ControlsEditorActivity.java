...
import com.pridroid.input.Binding;
import com.pridroid.input.ButtonElement;
import com.pridroid.input.ControlElement;
import com.pridroid.input.ControlElementDescription;
import com.pridroid.input.InputControlsView;
import com.pridroid.input.MouseStickElement;
import com.pridroid.input.WasdStickElement;
...
public class ControlsEditorActivity extends Activity implements InputControlsView.EditorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (instanceName != null) {
            renderScale = new com.pridroid.InstanceSettings(instanceName).getEffectiveRenderScale(sLong, sShort);
        } else {
