...
import com.pridroid.xconnector.UnixSocketConfig;
import com.pridroid.xconnector.XConnectorEpoll;
 ...
 * box64's connect() redirect maps to this host path (env PRIDROID_X11_SOCKET_DIR).
 */
public final class XServerRunner {
    private static final String TAG = "PriDroid/XServer";
