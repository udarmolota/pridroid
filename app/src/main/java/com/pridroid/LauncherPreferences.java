...
public class LauncherPreferences {
    ...
    // Must match names used in pridroid.c / pridroid_globals.h
    ...
    // PriDroid inherited PriDroid's >=720-line floor, but that made PA's desktop-sized UI
    ...
    // --- On-screen controls layout (JSON, see com.pridroid.input) ---
    ...
    // Stores an AppCompatDelegate.MODE_NIGHT_* constant; applied in PriDroidApplication.onCreate.
