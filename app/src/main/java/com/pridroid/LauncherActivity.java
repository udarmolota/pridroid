...
import com.pridroid.databinding.ActivityLauncherBinding;
    ...
    private static String[] fetchLatestTag() {
        try {
            java.net.HttpURLConnection c = (java.net.HttpURLConnection)
                    new java.net.URL("https://api.github.com/repos/udarmolota/pridroid/releases/latest")
                            .openConnection();
            ...
            try {
                if (json == null || json.trim().isEmpty()) {
                    try (InputStream in = getAssets().open(
                            com.pridroid.input.InputControlsView.DEFAULT_ASSET);
