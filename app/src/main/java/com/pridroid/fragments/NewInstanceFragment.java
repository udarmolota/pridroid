...
public class NewInstanceFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        btnPickZip.setOnClickListener(v -> zipPicker.launch(com.pridroid.C.mime.GAME_ARCHIVE));
    ...
    private static String freeDefaultName() {
        return com.pridroid.AppStorage.freeDefaultInstanceName();
    }
    ...
    private void startInstall() {
        ...
        if (com.pridroid.AppStorage.requireSingleton().getInstanceDir(instanceName).exists()) {
