...
public final class FmodDecodeSpike {
    private static final String TAG = "PriDroid/FmodSpike";
    ...
    public static final String PACK_ID = "pridroid.sound";
    public static final String PACK_DIR = "PriDroidSoundGenerated";
     ...
     * enable it. All local, no redistribution. Returns a summary; logs progress to PriDroid/SoundPack.
     */
    public static String generatePack(Context ctx, File instanceDir) {
        ...
        for (int i = 0; i < work.size(); i++) {
            ...
            if ((i % 200) == 0) Log.i("PriDroid/SoundPack", "decoded " + i + "/" + work.size() + " (ok=" + ok + " fail=" + fail + ")");
        }
        ...
        writeFile(new File(about, "About.xml"),
                ...
                "  <name>PriDroid Sound (generated)</name>\n" +
                "  <author>PriDroid</author>\n" +
        ...
        // "Game sound" toggle when ready (that adds pridroid.sound to ModsConfig). Decoupling build from
        ...
        Log.i("PriDroid/SoundPack", sb.toString());
        return sb.toString();
    }
    ...
    private static void writeFile(File f, String content) {
        ...
        catch (Throwable t) { Log.e("PriDroid/SoundPack", "write failed: " + f, t); }
    }
    ...
    private static void writeSilenceWav(File f, int rate, double seconds) {
        ...
        } catch (Throwable t) { Log.e("PriDroid/SoundPack", "silence write failed: " + f, t); }
    }
    ...
    public static String setSoundModActive(File instanceDir, boolean active) {
        ...
        try {
            ...
            if (active) {
                ...
                // drop "<li>pridroid.sound</li>" plus any leading whitespace/newline
