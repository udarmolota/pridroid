...
public class GameActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static final String TAG = "PriDroid/GameActivity";
    ...
    public static final String EXTRA_SMOKETEST = "pridroid_osmesa_smoketest";
    ...
    // Native input injection (pridroid_jni.c → box64). action 0=move,1=Ldown,2=Lup.
    ...
    private static com.pridroid.xserver.Pointer.Button xBtn(int button) {
        switch (button) {
            case 2:  return com.pridroid.xserver.Pointer.Button.BUTTON_MIDDLE;
            case 3:  return com.pridroid.xserver.Pointer.Button.BUTTON_RIGHT;
    ...
    public static void touchInput(int action, int x, int y) {
        ...
        if (action == 1) xs.injectPointerButtonPress(com.pridroid.xserver.Pointer.Button.BUTTON_LEFT);
    ...
    private static com.pridroid.xserver.XKeycode xKey(int sdlScancode) {
        switch (sdlScancode) {
            ...
            case 31: return com.pridroid.xserver.XKeycode.KEY_2;
            case 32: return com.pridroid.xserver.XKeycode.KEY_3;
            case 33: return com.pridroid.xserver.XKeycode.KEY_4;
            case 34: return com.pridroid.xserver.XKeycode.KEY_5;
            case 35: return com.pridroid.xserver.XKeycode.KEY_6;
            case 36: return com.pridroid.xserver.XKeycode.KEY_7;
            case 37: return com.pridroid.xserver.XKeycode.KEY_8;
            case 38: return com.pridroid.xserver.XKeycode.KEY_9;
            case 39: return com.pridroid.xserver.XKeycode.KEY_0;
            // arrows — the on-screen pan stick emits these scancodes (camera panning)
            case 79: return com.pridroid.xserver.XKeycode.KEY_RIGHT;
            case 80: return com.pridroid.xserver.XKeycode.KEY_LEFT;
            case 81: return com.pridroid.xserver.XKeycode.KEY_DOWN;
            case 82: return com.pridroid.xserver.XKeycode.KEY_UP;
            // function row (RimWorld: F1 help etc.; SDL scancodes 58..69 = F1..F12)
            case 58: return com.pridroid.xserver.XKeycode.KEY_F1;
            case 59: return com.pridroid.xserver.XKeycode.KEY_F2;
            case 60: return com.pridroid.xserver.XKeycode.KEY_F3;
            case 61: return com.pridroid.xserver.XKeycode.KEY_F4;
            case 62: return com.pridroid.xserver.XKeycode.KEY_F5;
            case 63: return com.pridroid.xserver.XKeycode.KEY_F6;
            case 64: return com.pridroid.xserver.XKeycode.KEY_F7;
            case 65: return com.pridroid.xserver.XKeycode.KEY_F8;
            case 66: return com.pridroid.xserver.XKeycode.KEY_F9;
            case 67: return com.pridroid.xserver.XKeycode.KEY_F10;
            case 68: return com.pridroid.xserver.XKeycode.KEY_F11;
            case 69: return com.pridroid.xserver.XKeycode.KEY_F12;
            case 74: return com.pridroid.xserver.XKeycode.KEY_HOME;
            case 77: return com.pridroid.xserver.XKeycode.KEY_END;
            case 76: return com.pridroid.xserver.XKeycode.KEY_DEL;
            default: return null;
        }
    }
    public static void keyInput(int scancode, int keycode, int down) {
        ...
        com.pridroid.xserver.XServer xs = com.pridroid.xserver.XServerRunner.getXServer();
        if (xs == null) return;
        com.pridroid.xserver.XKeycode xk = xKey(scancode);
        if (xk == null) return;
    ...
    public static void scrollInput(int x, int y, int dy) {
        ...
        if (xs == null) return;
        xs.injectPointerMove(x, y);
        com.pridroid.xserver.Pointer.Button b = dy > 0
                ? com.pridroid.xserver.Pointer.Button.BUTTON_SCROLL_UP
                : com.pridroid.xserver.Pointer.Button.BUTTON_SCROLL_DOWN;
    ...
    private com.pridroid.input.InputControlsView controls;
    ...
    private com.pridroid.input.GamepadHandler gamepad;   // physical controller -> MNK injection
    private com.pridroid.input.MouseKeyboardHandler mouseKb;  // physical mouse + keyboard -> SDL injection
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //   am start -n com.pridroid/.GameActivity --es instance_name X --ez autolaunch true
        if (getIntent().getBooleanExtra("autolaunch", false) && instanceName != null) {
            final com.pridroid.game.GameInstance gi =
                    com.pridroid.game.GameInstanceManager.requireSingleton().getByName(instanceName);
            if (gi != null) {
                new Thread(() -> {
                    try {
                    ...
                    catch (Throwable t) { android.util.Log.e("PriDroid", "autolaunch failed", t); }
                }, "rd-autolaunch").start();
            }
        }
        ...
        if (instanceName != null) {
            com.pridroid.InstanceSettings is = new com.pridroid.InstanceSettings(instanceName);
        ...
        if (fixedRes != com.pridroid.InstanceSettings.FIXED_NONE) {
            ...
            boolean wide = (fixedRes == com.pridroid.InstanceSettings.FIXED_720_16_9);
            ...
            // Log.i alone doesn't reach pridroid.log (logcat race), and this geometry is exactly
            ...
            com.pridroid.GameLauncher.lastFixedGeom = geom;
        } else {
        ...
        controls = new com.pridroid.input.InputControlsView(this, renderScale, instanceName);
        gamepad = new com.pridroid.input.GamepadHandler(this, controls);
        mouseKb = new com.pridroid.input.MouseKeyboardHandler(controls);
    ...
    private android.view.View createLoadingOverlay() {
        ...
        logo.setImageResource(R.drawable.pridroid_logo);
    ...
    /** Guest stdout is already bridged to logcat by pridroid.c. Use only stable PA milestones; the
    ...
    private static final com.pridroid.input.Binding[] PAN_KEYS = {
        com.pridroid.input.Binding.KEY_W, com.pridroid.input.Binding.KEY_D,
        com.pridroid.input.Binding.KEY_S, com.pridroid.input.Binding.KEY_A };
    ...
    public void onBackPressed() {
        ...
        if (!smokeTest && controls != null) {
            controls.inject(com.pridroid.input.Binding.KEY_ESCAPE, true);
            ui.postDelayed(() -> {
                if (controls != null)
                    controls.inject(com.pridroid.input.Binding.KEY_ESCAPE, false);
            }, 50);
            return;
        }
        super.onBackPressed();
    ...
    protected void onDestroy() {
        ...
        GameLauncher.setGameOverlayLogCallback(null);
        super.onDestroy();
        GameLauncher.destroyPriDroidWindow();
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (smokeTest) {
            ...
            try {
                String osmesa = com.pridroid.AppStorage.requireSingleton().getGl4esLibsPath()
                        + "/libOSMesa.so";
    ...
    private void pinGamePrefs(int width, int height) {
        try {
            ...
            com.pridroid.game.GameInstanceManager mgr =
                    com.pridroid.game.GameInstanceManager.requireSingleton();
            mgr.reload();
            com.pridroid.game.GameInstance gi = mgr.getByName(name);
            if (gi == null) return;
            ...
            //
            // PRIDROID_WINDOWED=1 puts the 1.5/SDL route on the same footing, as an A/B for the
            ...
            boolean windowed = new java.io.File(gi.getGamePath(), "rd_x11").exists()
                    || "1".equals(android.system.Os.getenv("PRIDROID_WINDOWED"));
            if (windowed)
