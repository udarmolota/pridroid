...
/**
 * Reads logcat output filtered by com.pridroid tag and forwards lines to callback.
 * Shows only pridroid-main, pridroid-emu, PriDroid/* tags — i.e. box64 and our own code.
 */
public class LogcatReader {

    private static final String TAG = "PriDroid/LogcatReader";
        ...
        thread = new Thread(() -> {
            try {
                ...
                process = new ProcessBuilder(
                        ...
                        "pridroid-main:I",    // box64 output via our pipe
                        "pridroid-emu:I",     // emulation init
                        "PriDroid/*:I",       // our Java tags
