 ...
 *
 * <p>This replaces RimDroid's RimWorld setup wholesale. Everything that lived here before was
 ...
 * preserved in RimDroid, none of it must run here.
 *
...
public final class RimWorldInstanceSetup {
     ...
     *  is kept from RimDroid (payload currently empty for Prison Architect); ".pack" entries are
